...
setup(
    ...
    version=VERSION,
    author="vLLM-Sophon team",
    license="Apache 2.0",
    description=("vLLM Sophon backend plugin"),
    ...
    extras_require={},
    entry_points={
        "vllm.platform_plugins": ["sophon = vllm_sophon:register"],
        "vllm.general_plugins":
        ["sophon_enhanced_model = vllm_sophon:register_model"],
    },
)
