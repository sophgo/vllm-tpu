...
WEIGHT_LOADER_V2_SUPPORTED = [
    ...
    "TPUInt8LinearMethod", "GPTQLinearMethod", "SophGPTQLinearMethod", "FBGEMMFp8LinearMethod",
...
class SophQKVParallelLinear(QKVParallelLinear):
    ...
    def forward(self, input_, output_gptq) -> tuple[torch.Tensor, Optional[Parameter]]:
        bias = self.bias if not self.skip_bias_add else None
